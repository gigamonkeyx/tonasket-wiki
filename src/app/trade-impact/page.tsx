...
const TariffImpactChart = dynamic(() => import('@/components/TariffImpactChart'), { ssr: false });
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="mb-4">
              <div className="h-64 bg-gray-800 dark:bg-gray-900 rounded p-4">
                <h3 className="text-lg font-medium text-white mb-4">Estimated Tariff Impact by Sector</h3>
            ...
            <p className="text-black dark:text-gray-300 text-sm flex items-center">
              ...
              Scroll to see all data. This chart shows the estimated impact of tariffs on key export categories from Okanogan County to Canada.
            </p>
          </div>
        </div>
